...
<h1 class="text-warning"><small class="text-primary"><i class="fas fa-user-plus"></i></small>  Add Student</h1>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="roll" type="text" value="<?= isset($roll)? $roll: '' ; ?>" class="form-control" pattern="[a-zA-Z0-9-]{15}" id="roll" required="">
	  	</div>
	  	<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="">
		    	...
		    	<option value="BSCS3-1">BSCS 3-1</option>
		    	<option value="BSCS3-2">BSCS 3-2</option>
		    	<option value="BSCS3-3">BSCS 3-3</option>
		    	<option value="BSCS3-4">BSCS 3-4</option>
		    	<option value="BSCS3-1N">BSCS 3-1N</option>
		    </select>
	  	</div>
	  	<div class="form-group">
